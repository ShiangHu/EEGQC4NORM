...
addpath(genpath('D:\OneDrive - CCLAB\Scripting\Toolbox\0-connectivity\SEED-G-toolbox'));

clear ;clc;
datadir   = 'D:\OneDrive - CCLAB\Scripting\Toolbox\0-connectivity\SEED-G-toolbox\real data';
data_path = 'D:\OneDrive\2_Projects\8 EEGQC\2022级\4. code\Paper2\DataGenerated';
chanloc = 'Standard-10-20-Cap15v2.locs';

name      = 'sLOR_cortical_sources.mat';
Struct    = load(fullfile(datadir,name));
Struct = Struct.EEG;
...
nyh_path = 'D:\OneDrive - CCLAB\Scripting\Toolbox\0-connectivity\SEED-G-toolbox\dependencies\NYH';
ft_path = 'D:\OneDrive - CCLAB\Scripting\Toolbox\0-connectivity\SEED-G-toolbox\dependencies\Fieldtrip';
